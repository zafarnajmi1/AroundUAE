...
extension Date {
    ...
    func dateString(dateFormate : String) -> String{
        let dateFormatter = DateFormatter()
        dateFormatter.dateFormat = dateFormate//"yyyy-MM-dd'T'HH:mm:ss.SSSZ"
        return  dateFormatter.string(from: self)
    }
    func dateStringForServer(dateFormate : String) -> String{
        let dateFormatter = DateFormatter()
         dateFormatter.timeZone = TimeZone(abbreviation: "UTC")
            dateFormatter.dateFormat = dateFormate//"yyyy-MM-dd'T'HH:mm:ss.SSSZ"
        return  dateFormatter.string(from: self)
    }
    static func formatedDateFromString(date : String, newFormate : String = "") -> String{
        let dateFormatter1 = DateFormatter()
        dateFormatter1.dateFormat = "yyyy-MM-dd'T'HH:mm:ss.SSSZ"
        
        let dateFormatter2 = DateFormatter()
        dateFormatter2.dateFormat = newFormate
